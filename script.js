...
const typeOfSport = document.querySelector("#sport")
const worldCupYear = document.querySelector("#year")
const headCoach = document.querySelector("#head-coach")
const playersDropdownList = document.querySelector('#players')
...
// myFavoriteFootballTeam.players.map(({name, position, number, isCaptain, nickname})=> {
//     console.log(name)
// })
